...
class VaultAddEditScreenTest : BitwardenComposeTest() {
    ...
    @Suppress("MaxLineLength")
    @Test
    fun `in ItemType_BankAccount changing account number visibility should trigger AccountNumberVisibilityChange`() {
        mutableStateFlow.value = DEFAULT_STATE_BANK_ACCOUNT.copy(
            viewState = VaultAddEditState.ViewState.Content(
                common = VaultAddEditState.ViewState.Content.Common(),
    ...
    @Test
    fun `in ItemType_BankAccount changing PIN visibility should trigger PinVisibilityChange`() {
        mutableStateFlow.value = DEFAULT_STATE_BANK_ACCOUNT.copy(
            viewState = VaultAddEditState.ViewState.Content(
                common = VaultAddEditState.ViewState.Content.Common(),
                type = VaultAddEditState.ViewState.Content.ItemType.BankAccount(pin = "1234"),
                isIndividualVaultDisabled = false,
            ),
        )
        composeTestRule
        ...
        verify(exactly = 1) {
            viewModel.trySendAction(
                VaultAddEditAction.ItemType.BankAccountType.PinVisibilityChange(isVisible = true),
            )
        }
    }
    ...
    @Test
    fun `in ItemType_BankAccount changing IBAN visibility should trigger IbanVisibilityChange`() {
        mutableStateFlow.value = DEFAULT_STATE_BANK_ACCOUNT.copy(
            viewState = VaultAddEditState.ViewState.Content(
                common = VaultAddEditState.ViewState.Content.Common(),
                type = VaultAddEditState.ViewState.Content.ItemType.BankAccount(iban = "DE89"),
                isIndividualVaultDisabled = false,
            ),
        )
        composeTestRule
        ...
        verify(exactly = 1) {
            viewModel.trySendAction(
                VaultAddEditAction.ItemType.BankAccountType.IbanVisibilityChange(isVisible = true),
            )
        }
    }
